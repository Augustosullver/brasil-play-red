import { Discord, Trophy, User, Info } from "lucide-react" import { Button } from "@/components/ui/button" import { Card, CardContent } from "@/components/ui/card"

export default function Home() { return ( <main className="min-h-screen bg-gradient-to-br from-black to-red-900 text-white p-6"> <header className="text-center py-8"> <h1 className="text-4xl font-bold">Brasil Play Red</h1> <p className="text-lg text-gray-300">O servidor SAMP que é a sua cara!</p> </header>
...
<section className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <Card className="bg-red-800/80">
      <CardContent className="p-4">
        ...
        <p>Baixe o SAMP, conecte ao IP: <b>brasilplayred.com.br:7777</b> e divirta-se.</p>
      </CardContent>
    </Card>
  ...
  <section className="mt-12 text-center">
    <div className="flex items-center justify-center gap-2 mb-2">
      <Discord className="text-white w-6 h-6" />
